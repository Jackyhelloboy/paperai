                ...
                <div className="space-y-3 text-gray-600">
                  ...
                  <ul className="space-y-2 ml-4">
                    <li className="flex items-start gap-2">
                      ...
                      <span>PP-OCRv5 for primary text recognition</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary-500 mt-1">&#x2022;</span>
                      <span>EasyOCR for additional language support</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary-500 mt-1">&#x2022;</span>
                      <span>OCR.space API for cloud-based fallback</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary-500 mt-1">&#x2022;</span>
                      <span>OpenCV for image preprocessing and enhancement</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary-500 mt-1">&#x2022;</span>
                      <span>Consensus scoring for result validation</span>
                    </li>
                  </ul>
                </div>
              </div>
